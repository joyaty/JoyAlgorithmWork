...
namespace Joy
{
    ...
    private:
        ...
        struct JoyListNode
        {
            ...
            JoyListNode(const T& data = T(), JoyListNode* pPrev = nullptr,
                        JoyListNode* pNext = nullptr)
                : Data(data)
                , Previous(pPrev)
                , Next(pNext)
            {}
    ...
    public:
        ...
        {
        public:
            using self_type  = JoyList<T>::Const_Iterator;
            using value_type = T;
            using reference  = T&;
            using pointer    = T*;
        ...
        public:
            const T& operator*(const Const_Iterator& iter) const { return this->Retrieve(); }
            // 前置++运算符重载
        ...
        protected:
            T& Retrieve() const { return m_pCurrent->Data; }
    ...
    public:
        ...
        const T& Back() const { return m_pHeader->data; }

        const T& Front() const { return m_pTail->data; }
