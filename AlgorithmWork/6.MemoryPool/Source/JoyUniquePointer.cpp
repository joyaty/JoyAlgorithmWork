...
namespace Joy
{
    namespace UnitTest_JoyUniquePointer
    {
        class TestCaseClass
        {
        public:
...
using Joy::UnitTest_JoyUniquePointer::TestCaseClass;
using Joy::UnitTest_JoyUniquePointer::TestCaseClass2;
...
void UnitTest_JoyUniquePointer()
{
    ...
    {
        // Dangerous code.
        void*           pTestMalloc = malloc(1);
        TestCaseClass2* pTestCase2  = new (pTestMalloc) TestCaseClass2();
        std::cout << "sizeof(*pTestCase2) = " << sizeof(*pTestCase2) << std::endl;
        void* pTestRelloc = realloc(pTestMalloc, 3);
        std::cout << "Malloc = " << pTestMalloc << ", Realloc = " << pTestRelloc
                  << ", pTestCase2 = " << pTestCase2 << std::endl;
    ...
    std::cout << "UnitTest_JoyUniquePointer 11111" << std::endl;
}
